...
@push('styles')
<link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;0,9..40,800;1,9..40,400&family=Instrument+Serif:ital@0;1&display=swap" rel="stylesheet">
<style>
    :root {
        --dd-forest:      #1A3D2B;
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    @keyframes meshFloat3 {
        ...
        to   { transform: translate(30px, -50px) scale(1.1) rotate(15deg); }
    }
    ...
    @keyframes pulse {
        0%, 100% { opacity: 1; transform: scale(1); box-shadow: 0 0 10px rgba(245,164,74,0.9); }
        50% { opacity: 0.75; transform: scale(1.35); box-shadow: 0 0 18px rgba(245,164,74,0.5); }
    }
    ...
    .hero-card-item:hover { color: rgba(255,255,255,0.9); }
    .hero-card-check {
    ...
    .hero-card-item:hover .hero-card-check { background: rgba(46,122,79,0.5); }
    .hero-card-check svg { width: 9px !important; height: 9px !important; color: #6DD68A; display: inline !important; }
    .hero svg, .feat-card svg, .btn-primary svg, .btn-ghost svg, .btn-primary-lg svg, .trust-item svg, .co-back svg { display: inline !important; flex-shrink: 0; }
    ...
    .limit-card.premium .limit-num { color: #F5A44A; text-shadow: 0 0 28px rgba(245,164,74,0.35); }
    .limit-bar-track {
        height: 8px; border-radius: 99px; margin-top: 14px;
        overflow: hidden;
    }
    .limit-card.free .limit-bar-track { background: var(--dd-border); }
    .limit-card.premium .limit-bar-track { background: rgba(255,255,255,0.08); }
    .limit-bar-fill {
    ...
    .limit-bar-fill.animated-prem  { width: 100% !important; background: linear-gradient(90deg, #C46A1E, #F5A44A); box-shadow: 0 0 12px rgba(245,164,74,0.4); }
    ...
    .compare-wrap .prem-col { background: rgba(26,61,43,0.025); }
    .compare-wrap tbody tr:hover td.prem-col { background: rgba(26,61,43,0.05); }
    ...
    .yes {
        ...
        color: var(--dd-forest-lit); font-size: 0.8rem; font-weight: 800;
    }
    .no {
        color: #C8D5CB; font-size: 1rem;
    }
    ...
    .social-text strong { color: rgba(255,255,255,0.65); font-weight: 600; }
...
<div style="font-family:'DM Sans',sans-serif; background:var(--dd-bg); min-height:100vh;">
        ...
        <div class="hero-inner">
            <div class="hero-layout">
                <div class="hero-left">
                    ...
                    <p class="hero-sub">
                        Één eenmalige betaling van €9,99. Geen abonnement, geen verborgen kosten. Levenslange toegang tot auto-bieden, inbox-prioriteit, statistieken en negen andere voordelen.
                    </p>
                    ...
                    <div class="social-strip">
                        ...
                        <p class="social-text"><strong>1.200+ gebruikers</strong><br>gingen je al voor</p>
                    </div>
                </div>

                <div class="hero-card">
                    <p style="font-size:0.66rem;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:rgba(255,255,255,0.3);margin:0 0 14px;">Eenmalig</p>
    ...
    <section id="features" class="section" style="padding-top:88px;">
        ...
        <div class="feat-grid reveal-stagger" style="margin-top:48px;">
            @php
            $features = [
                ['bg'=>'#E8F3EC','icon'=>'🤖','title'=>'Auto-bieden','desc'=>'Stel een maximumbod in en laat het systeem automatisch bieden. Nooit meer een kans missen terwijl je er niet bent.','accent'=>'#2E7A4F'],
                ['bg'=>'#FEF1E6','icon'=>'⭐','title'=>'Prioriteit in de inbox','desc'=>'Jouw berichten worden bovenaan de inbox van verkopers geplaatst, zodat je sneller reactie krijgt.','accent'=>'#E07B2A'],
                ['bg'=>'#E8F3EC','icon'=>'📊','title'=>'Advertentiestatistieken','desc'=>'Zie per advertentie hoeveel mensen hem openden of opsloegen. Optimaliseer jouw listings op basis van data.','accent'=>'#2E7A4F'],
                ['bg'=>'#FEF1E6','icon'=>'🔔','title'=>'Push notificaties','desc'=>'Kies categorieën, subcategorieën of specifieke items. Ontvang direct een melding bij nieuwe plaatsingen.','accent'=>'#E07B2A'],
                ['bg'=>'#E8F3EC','icon'=>'✨','title'=>'Uitlichtende border','desc'=>'Een gouden rand om jouw advertenties zodat kopers direct zien dat jij een premium verkoper bent.','accent'=>'#2E7A4F'],
                ['bg'=>'#EEF0FE','icon'=>'🚫','title'=>'Geen advertenties','desc'=>'Geen banners, geen pop-ups. Browse DirectDeal schoon, snel en afleidingsvrij.','accent'=>'#4F6AE0'],
                ['bg'=>'#FEF1E6','icon'=>'🗂️','title'=>'10 advertenties','desc'=>'Gratis gebruikers mogen 5 advertenties plaatsen. Jij hebt ruimte voor 10 actieve listings tegelijk.','accent'=>'#E07B2A'],
                ['bg'=>'#E8F3EC','icon'=>'🏅','title'=>'Premium badge','desc'=>'Een zichtbare badge op jouw profiel toont kopers dat je een serieuze en actieve verkoper bent.','accent'=>'#2E7A4F'],
                ['bg'=>'#E8F3EC','icon'=>'🔍','title'=>'Geavanceerde filters','desc'=>'Filter de inbox op premium/non-premium, datum, tijd en meer. Vind precies wat je zoekt.','accent'=>'#2E7A4F'],
            ];
            @endphp
        ...
        <div class="section" style="padding-top:88px; padding-bottom:88px;">
            ...
            <div class="limit-grid">
                <div class="limit-card free reveal">
                    <p style="font-size:0.7rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:var(--dd-sage);margin:0 0 14px;">Gratis</p>
                ...
                <div class="limit-card premium reveal">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
                        <p style="font-size:0.7rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.35);margin:0;">Premium</p>
                        <span class="prem-pill">👑 Premium</span>
                    </div>
                    <div style="display:flex;align-items:flex-end;gap:8px;margin-bottom:4px;">
                        <span class="limit-num">10</span>
                        <span style="font-size:0.9rem;color:rgba(255,255,255,0.4);padding-bottom:10px;">advertenties</span>
                    </div>
                    <div class="limit-bar-track">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $r[0] }}</td>
                        <td>
                            @if($r[1]) <span class="yes">✓</span>
                            @else      <span class="no">—</span>
                            @endif
                        </td>
                        <td class="prem-col">
                            @if($r[2]) <span class="yes">✓</span>
                            @else      <span class="no">—</span>
                            @endif
                        </td>
                    </tr>
    ...
    <section class="section" style="padding-top:40px; padding-bottom:108px;">
        <div class="cta-banner reveal">
            <div class="cta-banner-inner">
                <p style="font-size:0.66rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:rgba(255,255,255,0.28);margin:0 0 20px;">Klaar om te starten?</p>
...
<div class="sticky-cta" id="stickyCta" style="display:none;">
    <a href="{{ route('premium.checkout') }}" class="btn-primary-lg" style="width:100%;justify-content:center;padding:13px 24px;font-size:0.95rem;">
        Upgrade voor €9,99 →
    </a>
</div>
