        ...
        <div class="w-full max-w-md">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm">
                    Nog geen account?
                    <a href="{{ route('register') }}" class="text-[#2D6A4F] font-medium hover:underline">Registreer hier</a>
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        >
                        <button type="button" onclick="togglePassword('password', this)" class="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-700 transition-colors">
