...
@section('content')
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div class="hidden lg:flex flex-col justify-between bg-[#2D6A4F] p-12 relative overflow-hidden">
            ...
            <div class="flex flex-col gap-4 relative z-10">
                @foreach ([['01', 'Account aanmaken', 'Gratis en binnen 1 minuut'], ['02', 'Advertentie plaatsen', 'Met foto\'s en omschrijving'], ['03', 'Verkopen!', 'Direct contact met kopers']] as [$num, $title, $sub])
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required
                                placeholder="JouwEmail@gmail.com"
    ...
    <script>
        ...
        document.getElementById('password').addEventListener('input', function() {
            ...
            label.className = 'text-xs mt-1 ' + (score <= 1 ? 'text-red-400' : score === 2 ? 'text-orange-400' :
                score === 3 ? 'text-yellow-500' : 'text-[#2D6A4F]');
        });
    </script>
@endsection
